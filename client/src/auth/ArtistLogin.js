            ...
            <div className='signup_btn1'><a href='/artist'><h1 className='signup_artist'>artist</h1></a></div> 
              ...
              <MDBContainer>
                  <MDBRow>
                    <MDBCol md="8">
                      <MDBCard>
                          <MDBCardBody  className="mx-4"> <div className="text-center"> <h3 className="mb-5"> <strong>sign/in</strong> </h3> </div>
                        ...
                        <div className="text-center mb-3">
                          <MDBBtn onClick={this.handleSubmit} type="submit" gradient="blue" rounded className="btn-block z-depth-1a"> sign/in </MDBBtn>
                        </div>
                        ...
                        <p className="font-small grey-text d-flex justify-content-end"> Not a Member?<a href="/signup" className="blue-text ml-1"> sign/up</a></p>
                      </MDBModalFooter>
                    </MDBCard>
                  </MDBCol>
                </MDBRow>
